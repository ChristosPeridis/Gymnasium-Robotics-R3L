...
def get_base_ur10e_env(RobotEnvClass: Union[MujocoPyRobotEnv, MujocoRobotEnv]):
    """Factory function that returns a BaseUR10eEnv class that inherits
    from MujocoPyRobotEnv or MujocoRobotEnv depending on the mujoco python bindings.
    """

    class BaseUR10eEnv(RobotEnvClass):
        """Superclass for all UR10e environments."""
...
class MujocoPyUR10eEnv(get_base_ur10e_env(MujocoPyRobotEnv)):
...
class MujocoUR10eEnv(get_base_ur10e_env(MujocoRobotEnv)):
